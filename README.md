...
Key components
- Streamlit UI: travel_assistant/app.py — Q&A Assistant and Monitoring pages. Generated by me and Copilot 😄
...
When running notebooks you need to run qdrant locally:
```bash
